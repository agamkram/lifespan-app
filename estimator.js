...
(function (root) {
  ...
  // e_x remaining years — ages 16–100 from CDC NVSR 74-06 Tables 2–3.
  const LIFE_TABLE = {
    male: [
      60.5, 59.6, 58.6, 57.7, 56.7, 55.8, 54.9, 53.9, 53.0, 52.1, 51.2, 50.3, 49.4, 48.4,
      47.5, 46.6,
      ...
      4.1, 3.8, 3.5, 3.3, 3.0, 2.8, 2.6, 2.5, 2.3, 2.1, 2.0,
    ],
    female: [
      65.7, 64.7, 63.7, 62.7, 61.8, 60.8, 59.8, 58.9, 57.9, 56.9, 56.0, 55.0, 54.0, 53.1,
      52.1, 51.2,
      ...
      4.8, 4.5, 4.1, 3.8, 3.5, 3.3, 3.0, 2.8, 2.6, 2.4, 2.3,
    ],
  };
  ...
  function baseRemainingYears(age, sex) {
    const idx = clamp(Math.round(age), 16, 100) - 16;
  ...
  function estimate(inputs) {
    const age = clamp(Number(inputs.age) || 42, 16, 100);
